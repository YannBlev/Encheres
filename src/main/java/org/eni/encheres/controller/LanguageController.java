...
//
///**
// * Controller qui sert à changer de langue
// * Lorsqu'on fait un GET sur la route /i18n
// * Pour ca, il accède à l'instance de SessionLocaleResolver
// * qu'on amis dans le contexte Spring (dans la classe ApplicationConfig)
// */
//@Controller
